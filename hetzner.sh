...
# Other stuff
apt update
apt install -y vim gh npm zoxide fzf tmux htop redis-server lsof net-tools iperf3 jq strace kitty-terminfo libclang-dev python3.12-venv python3-pip btop atop
